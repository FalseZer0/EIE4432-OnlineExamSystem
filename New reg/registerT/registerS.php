        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-md-8" id="regbox">
                    <form enctype="multipart/form-data" id="signup-form" class="form" action="signupS.php" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" name="ebdaydate" type="date" placeholder="1999-08-19" id="bdayinput">
                            </div>
                        </div>
